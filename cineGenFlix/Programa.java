...
//    	FIM DO CADASTRO 
        ...
        morbius.setSinopse("Na tentativa de se curar de uma rara doen�aa sangu�nea, o cientista Michael Morbius (Jared Leto) \r\n" +
        ...
        batman.setSinopse("Nos dois anos em que protegeu as ruas como Batman (Robert Pattinson), provocando medo no cora��o dos criminosos, \r\n" +
        ...
        telefonePreto.setSinopse("Em O Telefone Preto, Finney Shaw, um garoto de 13 anos, � sequestrado por um s�dica serial killer (Ethan Hawke) em um por�o a prova de som, onde os gritos \r\n" +
    ...
    static void mostrarFilme(Filme filme) {
        ...
        System.out.println("\n" + filme.getNome() + "\n" + filme.getGenero() + "\n" +
            ...
            "Dura��o: " + filme.getDuracao() + " min\r\n" +
            "Diretor: " + filme.getDiretor() + "\r\n" +
            "Distribuidora: " + filme.getDistribuidora() + "\r\n" +
            "G�nero: " + filme.getGenero() + "\r\n" +
            "Classific�o: " + filme.getClassificacao() + " anos\n");
    }
}